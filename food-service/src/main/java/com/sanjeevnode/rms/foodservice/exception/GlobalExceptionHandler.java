...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleFoodAlreadyExistException(FoodAlreadyExistException ex) {
    ...
    public ResponseEntity<ApiResponse> handleFoodNotFoundException(FoodNotFoundException ex) {
